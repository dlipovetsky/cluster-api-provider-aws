...
// Convert_v1alpha4_AWSLoadBalancerSpec_To_v1alpha3_AWSLoadBalancerSpec is based on the autogenerated function and handles the Name field.
func Convert_v1alpha4_AWSLoadBalancerSpec_To_v1alpha3_AWSLoadBalancerSpec(in *v1alpha4.AWSLoadBalancerSpec, out *AWSLoadBalancerSpec, s apiconversion.Scope) error {
	if in.Name != nil && *in.Name != "" {
		return fmt.Errorf("Name field does not exist in v1alpha3")
	}
